...
describe('utils', function () {
  ...
  describe('toMobileFontSize', function () {
    it('minimum should be 12', function () {
      [].concat((0, _toConsumableArray3.default)(Array(12).keys())).forEach(function (value) {
    ...
    it('not modified from 12 to 26', function () {
      [].concat((0, _toConsumableArray3.default)(Array(14).keys())).forEach(function (value) {
  ...
  describe('addQueryParams', function () {
    it('should add a single query param', function () {
      (0, _chai.expect)((0, _index.addQueryParams)('url', { one: 'two' })).to.equal('url?one=two');
    });
    it('should add multiple query params', function () {
      (0, _chai.expect)((0, _index.addQueryParams)('url', { one: 'two', three: 'four' })).to.equal('url?one=two&three=four');
    });
    it('should escape param value', function () {
      (0, _chai.expect)((0, _index.addQueryParams)('url', { one: '?two' })).to.equal('url?one=%3Ftwo');
    });
  });
});