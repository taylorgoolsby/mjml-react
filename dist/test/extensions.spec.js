...
describe('extensions', function () {
  ...
  describe('simple comment', function () {
    ...
    it('should not render if comment is empty', function () {
      (0, _chai.expect)((0, _src.renderToMjml)(_react2.default.createElement(_extensions.MjmlComment, null))).to.equal('');
      (0, _chai.expect)((0, _src.renderToMjml)(_react2.default.createElement(
        _extensions.MjmlComment,
        null,
        ''
      ))).to.equal('');
  ...
  describe('conditional comment', function () {
    it('should render', function () {
      var comment = _react2.default.createElement(
        _extensions.MjmlConditionalComment,
        null,
        'First, solve the problem. Then, write the code.'
      );
      var markup = (0, _src.renderToMjml)(comment);
    ...
    it('should not render if comment is empty', function () {
      (0, _chai.expect)((0, _src.renderToMjml)(_react2.default.createElement(_extensions.MjmlConditionalComment, null))).to.equal('');
      (0, _chai.expect)((0, _src.renderToMjml)(_react2.default.createElement(
        _extensions.MjmlConditionalComment,
        null,
        ''
  ...
  describe('tracking pixel', function () {
    it('should render 1x1 raw image with provided src', function () {
      var markup = (0, _src.renderToMjml)(_react2.default.createElement(_extensions.MjmlTrackingPixel, { src: 'tracking-pixel' }));
